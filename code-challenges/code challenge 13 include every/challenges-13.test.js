...
// Solution code here...
const firstLetters = (arr) => arr.reduce( (accumulator, currentValue) => accumulator.concat([currentValue.charAt(0)]), []);
// };
...
// Solution code here...
const findHappiness = (arr) => arr.reduce( (accumulator, currentValue) => currentValue.includes(':)') ? accumulator.concat([currentValue]) : accumulator, []);
...
const standardizePhoneNumbers = (arr) => {
  ...
  return arr.reduce( (accumulator, currentValue) => {
    return accumulator.concat([currentValue.split('').reduce( (accumulatorSub, currentValueSub) => {
      return /\d/.test(currentValueSub) ? accumulatorSub + currentValueSub : accumulatorSub;
    }, '')]);
  }, []);
};
...
// Solution code here...
const onlyOddChars = (str) => str.split('').reduce((accumulator, currentValue, index) => index % 2 !== 0 ? accumulator + currentValue : accumulator, '');
// };
...
// const allHappy = (arr) => {
// Solution code here...
const allHappy = (arr) => arr.every((currentValue) => currentValue.includes(':)'));
// };
...
// Solution code here...
const findAnything = (arr, target) => arr.reduce( (accumulator, currentValue) => currentValue.includes(target) ? accumulator.concat([currentValue]) : accumulator, []);
// };
...
// const findEvery = (arr, target) => {
  // Solution code here...
  const findEvery = (arr, target) => arr.every((currentValue) => currentValue.includes(target));
// };
...
const unenrollBrook = (arr) => {
  // Solution code here...
  return arr.reduce((accumulator, currentValue) => {
    accumulator.push(currentValue.reduce(
      (accumulatorSub, currentValueSub)=> {
        if(!currentValueSub.includes('Brook')){
          accumulatorSub.push(currentValueSub);
        }
