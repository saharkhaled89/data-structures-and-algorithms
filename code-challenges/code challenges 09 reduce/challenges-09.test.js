...
// Solution code here...
const returnNames = (arr) => arr.reduce((accumulator, currentValue) => {
...
// Solution code here...
const reversedString = (str) => str.split('').reduce((accumulator, currentValue) => currentValue + accumulator);
// };
...
// Solution code here...
const countNumberOfChildren = (arr) => arr.reduce((accumulator, currentValue) => currentValue.children ? accumulator + currentValue.children.length : accumulator, 0);
...
const calculateAverage = (arr) => {
  // Solution code here...
  let contents = arr.reduce((accumulator, currentValue) => {
...
const countPrimeNumbers = (arr) => { return arr.reduce((accumulator, current) => isPrime(current) ? accumulator + 1 : accumulator, 0);};
