...
// const oddValues = (arr) => {
// Solution code here...
const oddValues = (arr) => arr.filter(number => number % 2 === 1);
// };
...
// Solution code here...
const filterStringsWithVowels = (arr) => arr.filter(word => (/[AaEeIiOoUu]/).test(word));
// };
...
// Solution code here...
const evenOddNumericValues = (arr) => arr.filter( (element) => typeof(element) === 'number').map( (element) => element % 2 === 0 ? 'even' : 'odd');
